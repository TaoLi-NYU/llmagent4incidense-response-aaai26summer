...
if __name__ == '__main__':
    ...
    set_seed(seed)
    device_map = {"": 0}
    # RESUME_ADAPTER = "/content/drive/MyDrive/llm_recovery_runs-continue-twodatasets/checkpoint-680" # checkpoint
    ...
    RESUME = "/content/drive/MyDrive/llm_recovery_runs-threedatasets/checkpoint-350" # checkpoint path
    ...
    LORA.supervised_fine_tuning(llm=llm, dataset=dataset, learning_rate=lr,
                                ...
                                progress_save_frequency=progress_save_frequency, seed=seed, resume_from_checkpoint=RESUME) # Checkpoint开关
