...
if __name__ == '__main__':
    ...
    instructions = instructions_states[:per_dataset] + instructions_new[:per_dataset] 
    ...
    LORA.supervised_fine_tuning(llm=llm, dataset=dataset, learning_rate=lr,
                                ...
                                progress_save_frequency=progress_save_frequency, seed=seed, resume_from_checkpoint=None) # Checkpoint
